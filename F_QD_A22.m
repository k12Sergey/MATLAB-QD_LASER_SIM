function [ q,R,fe2,fe1,fh,P1,P2,I] = F_QD_A22(gcn,gcp,g1,g2)
[ qd ] = QD_parameters();
Pe = gcn/(gcn+qd.gen);
Ph = gcp/(gcp+qd.gep);
D = qd.D2/qd.D1;
...
%     dd2 = gcp*(1-fh)-qd.gep*fh-(P1+P2)/6
    %output
    I = (P1*(gcn+qd.gen)*qd.D2+P2*(gcn+qd.gen)*qd.D2+(2*qd.gr1*fe1*fe2+4*qd.gr2*fe2*fe1))*qd.Ns*1.6e-19;
